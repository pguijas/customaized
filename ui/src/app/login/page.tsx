            ...
            <form className="mt-8 space-y-6" action="#">
                <div>
                    ...
                    <input type="email" name="email" id="email"
                           className="border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-100 border-gray-600 placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
